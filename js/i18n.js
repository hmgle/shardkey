...
(function () {
    ...
    var translations = {
        'zh-CN': {
            ...
            'errors.crt.min_pairs': '至少需要一组余数和模数',
            'errors.crt.length_mismatch': '余数和模数数组长度不匹配',
            ...
            'errors.challenge.only_v3': '仅支持 v3 挑战格式',
            ...
            'errors.challenge.secret_payload_length_field_invalid': '秘密载荷长度字段无效',
            ...
            'errors.challenge.params_invalid_moduli_bounds': '挑战参数无效（模数无法满足门限区间约束）',
            ...
            'errors.shard.only_v3': '仅支持 v3 分片格式',
            ...
            'errors.shard.checksum_invalid': '分片校验字段无效',
            'errors.shard.encoding_invalid': '不支持的分片秘密编码格式',
            'errors.shard.modulus_invalid': '分片模数无效',
            'errors.shard.remainder_invalid': '分片余数无效',
            ...
            'errors.shard.moduli_not_coprime': '分片模数不互素，可能混入了重复或损坏的分片。',
            'errors.shard.checksum_mismatch': '恢复结果校验失败，部分分片可能不正确。',
        ...
        en: {
            ...
            'errors.crt.min_pairs': 'At least one remainder/modulus pair is required',
            'errors.crt.length_mismatch': 'Remainders and moduli arrays must have the same length',
            ...
            'errors.challenge.only_v3': 'Only v3 challenge format is supported',
            ...
            'errors.challenge.secret_payload_length_field_invalid': 'Invalid secret payload length field',
            ...
            'errors.challenge.params_invalid_moduli_bounds': 'Invalid challenge parameters (moduli do not satisfy threshold bounds)',
            ...
            'errors.shard.only_v3': 'Only v3 shard format is supported',
            ...
            'errors.shard.checksum_invalid': 'Invalid shard checksum field',
            'errors.shard.encoding_invalid': 'Unsupported shard secret encoding',
            'errors.shard.modulus_invalid': 'Invalid shard modulus',
            'errors.shard.remainder_invalid': 'Invalid shard remainder',
            ...
            'errors.shard.moduli_not_coprime': 'Shard moduli are not pairwise coprime. Duplicate or corrupted shards may be mixed in.',
            'errors.shard.checksum_mismatch': 'Recovery checksum failed. Some shards may be incorrect.',
        ...
        ja: {
            ...
            'errors.crt.min_pairs': '余りと法の組が少なくとも 1 組必要です',
            'errors.crt.length_mismatch': '余り配列と法配列の長さが一致しません',
            ...
            'errors.challenge.only_v3': 'v3 形式のみ対応しています',
            ...
            'errors.challenge.secret_payload_length_field_invalid': '秘密ペイロード長フィールドが無効です',
            ...
            'errors.challenge.params_invalid_moduli_bounds': 'チャレンジパラメータが無効です（法がしきい値条件を満たしません）',
            ...
            'errors.shard.only_v3': 'v3 分片形式のみ対応しています',
            ...
            'errors.shard.checksum_invalid': '分片のチェックサム欄が無効です',
            'errors.shard.encoding_invalid': '未対応の分片秘密エンコーディングです',
            'errors.shard.modulus_invalid': '分片の法が無効です',
            'errors.shard.remainder_invalid': '分片の剰余が無効です',
            ...
            'errors.shard.moduli_not_coprime': '分片の法が互いに素ではありません。重複または破損した分片が混ざっている可能性があります。',
            'errors.shard.checksum_mismatch': '復元後のチェックサム検証に失敗しました。誤った分片が含まれている可能性があります。',
        ...
        'zh-TW': {
            ...
            'errors.crt.min_pairs': '至少需要一組餘數與模數',
            'errors.crt.length_mismatch': '餘數與模數陣列長度不匹配',
            ...
            'errors.challenge.only_v3': '僅支援 v3 挑戰格式',
            ...
            'errors.challenge.secret_payload_length_field_invalid': '秘密載荷長度欄位無效',
            ...
            'errors.challenge.params_invalid_moduli_bounds': '挑戰參數無效（模數無法滿足門檻區間約束）',
            ...
            'errors.shard.only_v3': '僅支援 v3 分片格式',
            ...
            'errors.shard.checksum_invalid': '分片校驗欄位無效',
            'errors.shard.encoding_invalid': '不支援的分片秘密編碼格式',
            'errors.shard.modulus_invalid': '分片模數無效',
            'errors.shard.remainder_invalid': '分片餘數無效',
            ...
            'errors.shard.moduli_not_coprime': '分片模數不互素，可能混入了重複或損壞的分片。',
            'errors.shard.checksum_mismatch': '恢復結果校驗失敗，部分分片可能不正確。',
